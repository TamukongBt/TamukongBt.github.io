...
import { BookOpen, Dice3, Home, Popcorn } from "lucide-react";
import { Menubar, MenubarMenu, MenubarTrigger } from "@/components/ui/menubar";
// Adjust the import path based on your project structure

const BottomMenubar = () => {
  return (
    <Menubar className="fixed rounded-xl md:hidden !z-30  !bg-eerieblack bottom-10 left-5 right-5 bg-purple text-white ">
      <MenubarMenu>
