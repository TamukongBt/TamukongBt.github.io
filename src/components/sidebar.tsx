      ...
      <TooltipProvider>
        ...
        <aside className="z-10 hidden w-14 flex-col border-brownsugar border h-[98vh] bg-eerieblack sm:flex">
          <div className="bg-eerieblack border-b border-brownsugar h-[3.5rem] py-2 font-bold font-display capitalize">
            <Link
              href="/"
              className="px-4 text-2xl text-lemonchiffon leading-3 my-auto flex align-middle items-center h-full tracking-widest"
            >
              TB
            </Link>
          </div>
          <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
            ...
            <Tooltip>
              ...
              <TooltipContent
                side="right"
                className="bg-bittersweet text-eerieblack border-0"
              >
                Work
              </TooltipContent>
            </Tooltip>
