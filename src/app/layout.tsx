  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Josefin+Sans:ital,wght@0,100..700;1,100..700&family=Monoton&family=Source+Sans+3:ital,wght@0,200..900;1,200..900&display=swap"
          rel="stylesheet"
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Caesar+Dressing&family=Chokokutai&family=Dancing+Script:wght@400..700&family=Figtree:ital,wght@0,300..900;1,300..900&family=League+Spartan:wght@100..900&family=Monoton&family=Mynerve&family=Passion+One:wght@400;700;900&family=Pirata+One&family=Prata&family=Tiny5&family=Ubuntu+Mono:ital,wght@0,400;0,700;1,400;1,700&family=Yanone+Kaffeesatz:wght@200..700&display=swap"
          rel="stylesheet"
        ></link>
        <link
          href="https://fonts.googleapis.com/css2?family=Climate+Crisis&family=Doto:wght@100..900&family=Mrs+Saint+Delafield&display=swap"
          rel="stylesheet"
        ></link>
      </head>
      <body className="font-sans">
        <ApolloWrapper>
          <main className="flex h-[100dvh] w-full bg-eerieblack md:p-2">
            ...
            <div className="sm:hidden md:block flex-shrink-0">
              {/* <BottomMenubar /> */}
              <SideBar />
            </div>
            <div className="flex flex-col flex-1 min-w-0 bg-eerieblack overflow-y-auto">
              <Header />
              {children}
              <Toaster />
              {/* <FireflyEffect /> */}
